...
src_files += 	android_sqlite_icu_IcuCursor.c \
	     	android_sqlite_icu_SQLiteIcuDatabase.c \
		android_sqlite_icu_IcuPreparedStatement.c \
		android_sqlite_icu.c \
		sqlite3.c
...
LOCAL_MODULE := libandroid_sqlite_icu
